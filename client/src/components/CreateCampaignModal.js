                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="px-6 py-4 space-y-4">
                            ...
                            <div className="space-y-4 pt-2 border-t border-gray-200">
                                <h4 className="text-sm font-medium text-gray-900">Call Settings</h4>
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        ...
                                        <input
                                            type="number"
                                            name="callSettings.maxConcurrentCalls"
                                            value={formData.callSettings.maxConcurrentCalls}
                                            onChange={(e) => setFormData(prev => ({
                                                ...prev,
                                                callSettings: {
                                                    ...prev.callSettings,
                                                    maxConcurrentCalls: parseInt(e.target.value) || 2
                                                }
                                            }))}
                                            min="1"
                                            max="10"
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="number"
                                            name="callSettings.retryAttempts"
                                            value={formData.callSettings.retryAttempts}
                                            onChange={(e) => setFormData(prev => ({
                                                ...prev,
                                                callSettings: {
                                                    ...prev.callSettings,
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="number"
                                            name="callSettings.retryDelayMinutes"
                                            value={formData.callSettings.retryDelayMinutes}
                                            onChange={(e) => setFormData(prev => ({
                                                ...prev,
                                                callSettings: {
                                                    ...prev.callSettings,
                                    ...
                                    <div>
                                        ...
                                        <input
                                            type="number"
                                            name="callSettings.callTimeoutSeconds"
                                            value={formData.callSettings.callTimeoutSeconds}
                                            onChange={(e) => setFormData(prev => ({
                                                ...prev,
                                                callSettings: {
                                                    ...prev.callSettings,

...
const Compliance = () => {
  ...
  // Define these variables to fix the eslint errors
      ...
      <div className="bg-white rounded-lg shadow-sm p-6">
        ...
        <div className="bg-gray-50 rounded-lg p-4 mb-4">
          <p className="text-sm text-gray-900 font-mono">
            Hi <code>{first_name}</code>, this is an automated call from <code>{company}</code> about <code>{topic}</code>. By continuing, you consent to this automated call. If you do not wish to be contacted, say 'Stop' or 'Remove me'.
          </p>
        ...
        <div className="space-y-3">
          <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            <div className="flex items-center">
              ...
              <span className="text-sm text-gray-900">
                Consent logged for +91-98xxx-xxxxx
              </span>
            </div>
          ...
          <div className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
            <div className="flex items-center">
              ...
              <span className="text-sm text-gray-900">
                Number added to DNC: +1-555-xxx-xxxx
              </span>
            </div>

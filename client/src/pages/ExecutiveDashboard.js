    ...
    return ( <
            ...
            div className = "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6" > {
                metrics.map((metric, index) => ( <
                    ...
                    /> < /
                    div > <
                    span className = { `text-sm font-medium ${metric.changeColor}` } > { metric.change } <
                    /span> < /
                    div > <
                    div >
                    <
            ...
            div className = "space-y-4" > {
                conversionFunnel.map((stage, index) => ( <
                    ...
                    div > <
                    /div> <
                    span className = "text-sm text-gray-600 w-20 text-right" > { stage.value }({ stage.percentage } % ) <
                    /span> < /
                    div >
                ))
            } <
            ...
            { /* Recent Performance */ } <
            div className = "grid grid-cols-1 lg:grid-cols-2 gap-6" > { /* Recent Calls with Emotions */ } <
            div className = "bg-white rounded-lg shadow-sm p-6" >
            <

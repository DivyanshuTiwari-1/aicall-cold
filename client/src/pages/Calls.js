    ...
    return ( <
        ...
        tbody className = "bg-white divide-y divide-gray-200" > {
            mockCalls.map((call) => ( <
                ...
                div >
                <
                div className = "text-sm font-medium text-gray-900" > { call.contact.firstName } { call.contact.lastName } <
                /div> <
                div className = "text-sm text-gray-500" > { call.contact.phone } <
                /div> <
                /div> <
                /td> <
                td className = "px-6 py-4 whitespace-nowrap text-sm text-gray-900" > { call.campaign } <
                /td> <
                td className = "px-6 py-4 whitespace-nowrap" >
                <
                ...
                <
                span className = { call.score >= 70 ? 'text-blue-600' : 'text-green-600' } > { call.score } %
                <
                /span> <
                /td> <
                td className = "px-6 py-4 whitespace-nowrap text-sm text-gray-900" > { call.bestTime } <
                /td> <
                td className = "px-6 py-4 whitespace-nowrap" > {
                    call.csat ? ( <
                        div className = "flex items-center" > {
                            call.csat >= 4 ? ( <
                                svg className = "h-4 w-4 text-orange-500 mr-1"
                                fill = "currentColor"
                                viewBox = "0 0 20 20" >
                                <
